...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.parameters'
        db.add_column(u'layers_layer', 'parameters',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.driver'
        db.add_column(u'layers_layer', 'driver',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.parameters'
        db.delete_column(u'layers_layer', 'parameters')

        # Deleting field 'Layer.driver'
        db.delete_column(u'layers_layer', 'driver')
