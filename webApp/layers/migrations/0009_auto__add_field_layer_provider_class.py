...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.provider_class'
        db.add_column(u'layers_layer', 'provider_class',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.provider_class'
        db.delete_column(u'layers_layer', 'provider_class')
    ...
    models = {
        u'layers.layer': {
            ...
            'provider_class': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
