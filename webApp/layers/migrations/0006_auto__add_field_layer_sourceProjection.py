...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.sourceProjection'
        db.add_column(u'layers_layer', 'sourceProjection',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.sourceProjection'
        db.delete_column(u'layers_layer', 'sourceProjection')
